...
{
    /// <inheritdoc />
    public partial class AddPromptExecutions : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    result_content = table.Column<string>(type: "text", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_prompt_executions", x => x.id);
                    table.ForeignKey(
                        name: "fk_prompt_executions_prompts_prompt_id",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_prompt_executions_prompt_id",
